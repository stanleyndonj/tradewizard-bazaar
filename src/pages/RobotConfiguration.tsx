              ...
              <form onSubmit={handleSubmit}>
                <TabsContent value="strategy" className="mt-6 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-3 sm:grid-cols-6">
                      {['M5', 'M15', 'M30', 'H1', 'H4', 'D1'].map((tf) => (
                        <Button 
                          ...
                          className={timeframe === tf ? 'bg-trading-blue' : ''}
                  ...
                  <div className="flex justify-end">
                    <Button 
                      type="button" 
                      className="bg-trading-blue hover:bg-trading-darkBlue"
                ...
                <TabsContent value="contact" className="mt-6 space-y-6">
                  <div className="glass-card rounded-xl p-6">
                    ...
                    <p className="text-muted-foreground mb-6">Please provide your contact details so we can deliver your custom robot.</p>
