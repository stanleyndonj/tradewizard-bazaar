...
Revision ID: 1f7d75ab48a2
Revises: 
Create Date: 2025-04-25 22:44:14.337115
...
def upgrade() -> None:
    ...
    sa.Column('last_message_time', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
